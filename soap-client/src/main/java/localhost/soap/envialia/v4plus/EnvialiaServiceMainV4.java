...
@Service
public class EnvialiaServiceMainV4 {
	
	private static Logger log = LogManager.getLogger(EnvialiaServiceMainV4.class);
    ...
    public String getDeliveryDate() {
    	...
    	try {
    		...
    		EnvialiaHelper<?,?> loginDep2Helper = new EnvialiaHelper<LoginDep2Pojo,LoginDep2ResponsePojo>(idSessionHeader, loginDep2Pojo, new LoginDep2ResponsePojo());
    		...
    		EnvialiaHelper<?,?> consEnvio2Helper = new EnvialiaHelper<ConsEnvio2Pojo,ConsEnvio2ResponsePojo>(idSessionHeader, consEnvio2Pojo, new ConsEnvio2ResponsePojo());
    		...
    		EnvialiaHelper<?,?> consEnvEstadosHelper = new EnvialiaHelper<ConsEnvEstadosPojo,ConsEnvEstadosResponsePojo>( idSessionHeader, consEnvEstadosPojo, new ConsEnvEstadosResponsePojo());
