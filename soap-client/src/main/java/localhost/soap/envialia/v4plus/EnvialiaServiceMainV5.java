...
public class EnvialiaServiceMainV5 {
	...
	@Value("${alberto.tracking}")
	private String albertoTracking;
	...
	public void main () {
		...
		fechaHoraEntrega = getDeliveryDate(albertoTracking); 
		log.info("fechaHoraEntrega: {}", fechaHoraEntrega);
	}


	public String getDeliveryDate(String tracking) {
		...
		try {
			...
			// incidencia 31, begin
			consEnvEstadosHelper.obtainJsonfromEnvioEstado(strEnvEstados);
			// incidencia 31, end
